<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\index\news.html";i:1502262675;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\header.html";i:1502248770;s:78:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\aside.html";i:1502275551;s:82:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\copyright.html";i:1502104224;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\footer.html";i:1502097616;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <a class="btn btn-sm btn-primary" href="<?php echo url('index/addnews'); ?>"><i class="fa fa-plus"></i> 发布新闻</a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example newslist" id="logtable">
                            ...
                            <?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): if( count($news)==0 ) : echo "" ;else: foreach($news as $key=>$vo): ?>
                               <tr>                               
                                    ...
                                    <td>
                                       <a  href ="<?php echo url('index/editnews',array('id'=>$vo['id'])); ?>" class="btn btn-primary">编辑</a>
                                       <a href ="<?php echo url('index/deletenews',array('id'=>$vo['id'])); ?>" class="btn btn-danger">删除</a>
                                    </td>          
                                </tr>
