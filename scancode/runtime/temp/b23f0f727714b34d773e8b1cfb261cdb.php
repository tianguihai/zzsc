<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\index\editcate.html";i:1502245785;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\header.html";i:1502248770;s:78:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\aside.html";i:1502275551;s:82:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\copyright.html";i:1502104224;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\footer.html";i:1502097616;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="signupForm" method="POST" action="<?php echo url('index/editcate'); ?>">
                            
                            <div class="form-group">
                                <label class="col-sm-3 control-label">分类名：</label>
                                <div class="col-sm-8">
                                    <input name="catename" class="form-control"  value="<?php echo $cate['catename']; ?>" type="text" required>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <select name="parentid" class="form-control">
                                        ...
                                        <?php if(is_array($cates) || $cates instanceof \think\Collection || $cates instanceof \think\Paginator): if( count($cates)==0 ) : echo "" ;else: foreach($cates as $key=>$vo): ?>
                                            ...
                                            <?php if($vo['id'] == $cate['parentid']): ?> selected="" <?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="order" class="form-control" value="<?php echo $cate['order']; ?>" type="number">
                                </div>
                            </div>                           
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="status" size="1">
                                        <option value="1" <?php if($cate['status']==1): ?> selected="" <?php endif; ?>>启用</option>
                                        <option value="0" <?php if($cate['status']==0): ?> selected="" <?php endif; ?> >禁用</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="url" class="form-control" value="<?php echo $cate['url']; ?>" type="text">
                                </div>
                            </div>
