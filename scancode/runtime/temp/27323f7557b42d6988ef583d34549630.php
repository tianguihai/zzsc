<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\feedback\index.html";i:1502187905;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\header.html";i:1502248770;s:78:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\aside.html";i:1502275551;s:82:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\copyright.html";i:1502104224;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\footer.html";i:1502097616;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example newslist" id="logtable">
                        ...
                        <?php if(is_array($feedbacks) || $feedbacks instanceof \think\Collection || $feedbacks instanceof \think\Paginator): if( count($feedbacks)==0 ) : echo "" ;else: foreach($feedbacks as $key=>$vo): ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php if($vo['status']==1): ?> 未查看
                                    <?php else: ?> 已查看
                                    <?php endif; ?>
                                    </td>
                                    <td>
                                       <a  href ="<?php echo url('feedback/reply',array('id'=>$vo['id'])); ?>" class="btn btn-primary">查看</a>
                                       <a href ="<?php echo url('feedback/delcontact',array('id'=>$vo['id'])); ?>" class="btn btn-danger">删除</a>
                                    </td>
                                </tr>  
