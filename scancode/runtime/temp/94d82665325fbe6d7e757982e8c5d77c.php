<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\index\addcate.html";i:1502243696;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\header.html";i:1502248770;s:78:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\aside.html";i:1502275551;s:82:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\copyright.html";i:1502104224;s:79:"D:\phpStudy\WWW\scancode\public/../application/scancode\view\common\footer.html";i:1502097616;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="signupForm" method="POST" action="<?php echo url('index/addcates'); ?>">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">分类名：</label>
                                <div class="col-sm-8">
                                    <input name="catename" class="form-control"  value="" type="text" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="order" class="form-control" value="" type="number">
                                </div>
                            </div>                           
                            <div class="form-group">
